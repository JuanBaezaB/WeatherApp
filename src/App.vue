      ...
      <header class="container flex items-center justify-between h-16 px-4 mx-auto rounded dark:dark:bg-gray-900">
        <a rel="noopener noreferrer" href="#" aria-label="Homepage">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32"
            class="w-6 h-6 dark:dark:text-violet-400">
            <path
        ...
        <div class="flex gap-2">
          <button class="flex items-center justify-center p-1 bg-slate-500 rounded">
            <MagnifyingGlassIcon class="w-4 h-4 dark:dark:text-gray-50" />
          </button>
          <button class="flex items-center justify-center p-1 bg-slate-500 rounded">
            <MapPinIcon class="w-4 h-4 dark:dark:text-gray-50" />
          </button>
        </div>
